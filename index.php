...
<script>
    ...
    function fetchNotifications() {
        fetch('get-notifications.php') // Call the PHP script to fetch notifications
            .then(response => response.json())
            .then(data => {
                const notificationContainer = document.getElementById('notificationContainer');
                notificationContainer.innerHTML = '<h2>Notifications</h2>'; // Reset content to prevent duplication
                ...
                if (data.length > 0) {
                    ...
                    noNotificationDiv.classList.add('notification');
                    noNotificationDiv.textContent = 'No new notifications';
                    notificationContainer.appendChild(noNotificationDiv);
                }
            })
    ...
    const notificationContainer = document.getElementById('notificationContainer');
        ...
        function addNotification(message) {
            ...
            // Ensure only 5 notifications are visible
        ...
        // // Example: Adding new notifications dynamically
        // setTimeout(() => addNotification('New notification added'), 2000);
        // setTimeout(() => addNotification('Another notification'), 4000);
